<?php
class PageRESTController extends WPAPIRESTController {
    ...
    protected function getPage($post) {
        // Get requested posts
    ...
    protected function postPage($data) {
        $new_post = array();
    ...
    protected function putPage($data) {
    ...
    protected function deletePage($post) {
