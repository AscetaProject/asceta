...
/**
 * English strings for modmediawiki
 *
...
$string['available_servers'] = "Available Mediawiki Servers";
...
$string['page_title_empty'] = "Page Title can not be empty";
$string['page_content_empty'] = "Page Content can not be empty";
$string['save'] = "Save";
$string['back'] = "Back";
$string['title'] = "Title";
$string['resumen'] = "Resume";
