...
echo "                            <br>";
echo "                            <span class='bold'>Research field: <a href='http://www.mendeley.com/".str_replace(" ", "-", strtolower($main->discipline_name))."/' target='_blank'>$main->discipline_name</a></span>";
echo "                            <br>";
...
if (empty($cv->employment) && empty($cv->education) && empty($contact) && empty($main->location)){
    echo "                 <div class='empty text-minor'>No CV information added yet.</div>";
} else {
    if(!empty($cv->employment)){
    ...
    if(!empty($contact) && !empty($main->location)){
